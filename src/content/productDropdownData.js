...
export const productDropdownData = {
  ...
  "Advertising & APIs": [
    { title: "Click-to-WhatsApp Ads", desc: "Ads that start conversations", icon: Rocket, path: "/products/ctwa-ads", comingSoon: true },
    { title: "Messaging APIs", desc: "Scale with programmable messaging", icon: MessageSquare, path: "/products/messaging-apis", comingSoon: true },
    { title: "Voice APIs", desc: "Interactive voice experiences", icon: Phone, path: "/products/voice-apis", comingSoon: true },
    { title: "Verification APIs", desc: "Secure multi-factor auth", icon: Shield, path: "/products/verification-apis", comingSoon: true },
  ],
  Channels: [
    ...
    { title: "Instagram", desc: "Engage customers on Instagram", icon: FaInstagram, path: "/solutions/social-commerce-suite" },
  ],
};
